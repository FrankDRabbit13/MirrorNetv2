...
export default function FaqPage() {
  const faqItems = [
    ...
    {
      question: "How do Reveal Requests & Tokens work?",
      answer: (
         <div className="space-y-2">
            <p>Premium Tokens are a flexible currency for special actions. As a Premium member, you get new tokens every month. You can use them in two ways:</p>
            <ul className="list-disc list-inside space-y-1 pl-2">
                <li><strong>Request a Reveal:</strong> If you receive an anonymous Attraction Rating, you can use a token to send a 'Reveal Request' to the person who rated you. They can choose to accept (revealing their identity) or decline. The token is used either way.</li>
                <li><strong>Rate Outside Your Circles:</strong> You can use a token to give an Attraction Rating to any user on the platform, even if you don't share a circle with them.</li>
            </ul>
        </div>
      )
    },
